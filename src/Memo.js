...
const Memo = () => {
  ...
  const [memoPlace, setMemoPlace] = useState([]);
  ...
  function submitHandler() {
    ...
    formData.append(
      'place',
      new Blob([JSON.stringify(memoPlace)], { type: 'application/json' }),
    );
    axios
      .post('http://localhost:8080/memo', formData, {
        headers: {
